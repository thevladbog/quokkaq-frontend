...
export function AdScreenSettings({ unitId, currentConfig }: AdScreenSettingsProps) {
    ...
    const [selectedMaterials, setSelectedMaterials] = useState<string[]>(adConfig.activeMaterialIds || []);
    const [logoUrl, setLogoUrl] = useState(adConfig.logoUrl || '');
    const [isCustomColorsEnabled, setIsCustomColorsEnabled] = useState(adConfig.isCustomColorsEnabled || false);
    ...
    const uploadMutation = useMutation({
        ...
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['units', unitId, 'materials'] });
    ...
    const deleteMutation = useMutation({
        mutationFn: (materialId: string) => unitsApi.deleteMaterial(unitId, materialId),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['units', unitId, 'materials'] });
        ...
        <div className="space-y-6">
            <Card>
                ...
                <CardContent className="space-y-6">
                    ...
                    <Button onClick={handleSaveSettings} disabled={updateUnitMutation.isPending}>
