...
export default function UnitPreRegistrationsPage({ params }: UnitPreRegistrationsPageProps) {
        ...
        <div className="container mx-auto p-4 flex-1">
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                <DialogContent className="sm:max-w-[600px]">
                    <DialogHeader>
                        <DialogTitle>{selectedPreReg ? t('edit_title') : t('create_title')}</DialogTitle>
                        <DialogDescription>
